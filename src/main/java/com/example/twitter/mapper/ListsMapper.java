...
import com.example.twitter.model.TweetMapper;
...
import com.example.twitter.service.ListsService;
...
public class ListsMapper {
    ...
    public ListUserResponse createTweetList(UserToListsRequest.ListsRequest listsRequest) {
    ...
    public BaseListResponse editTweetList(UserToListsRequest.ListsRequest listsRequest) {
