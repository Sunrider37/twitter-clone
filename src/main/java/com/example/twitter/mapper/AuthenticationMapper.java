...
public class AuthenticationMapper {
    ...
    public String sendPasswordResetCode(String email, BindingResult bindingResult) throws MessagingException {
        processInputErrors(bindingResult);
    ...
    public String sendRegistrationCode(String email, BindingResult bindingResult) throws MessagingException {
        processInputErrors(bindingResult);
