...
import com.example.twitter.dto.response.notification.NotificationTweetResponse;
...
public class TweetController {
    ...
    public ResponseEntity<NotificationTweetResponse> likeTweet(@PathVariable Long tweetId) {
        ...
        return getNotificationTweetResponseEntity(notification);
    }

    private ResponseEntity<NotificationTweetResponse> getNotificationTweetResponseEntity(NotificationResponse notification) {
