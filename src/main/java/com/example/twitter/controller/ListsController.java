...
import com.example.twitter.dto.response.lists.*;
import com.example.twitter.mapper.ListsMapper;
...
public class ListsController {
    ...
    @PostMapping
    public ResponseEntity<ListUserResponse> createTweetList(@RequestBody UserToListsRequest.ListsRequest listsRequest) {
        return ResponseEntity.ok(listsMapper.createTweetList(listsRequest));
    }

    @PutMapping
    public ResponseEntity<BaseListResponse> editTweetList(@RequestBody UserToListsRequest.ListsRequest listsRequest) {
    ...
    public ResponseEntity<List<TweetResponse>> getTweetsByListId(@PathVariable Long listId,
