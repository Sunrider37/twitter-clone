...
import com.example.twitter.exception.InputFieldException;
import com.example.twitter.model.User;
import com.example.twitter.repository.UserRepository;
import com.example.twitter.repository.projection.user.AuthUserProjection;
import com.example.twitter.repository.projection.user.UserCommonProjection;
import com.example.twitter.security.JwtProvider;
import com.example.twitter.security.UserPrincipal;
import com.example.twitter.service.AuthenticationService;
import com.example.twitter.service.mail.MailSender;
...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Override
    @Transactional
    public String sendRegistrationCode(String email) throws MessagingException {
